...
kill_ra_and_standard_emulators() { 
    ...
    killall -q -15 ra32.miyoo retroarch retroarch.$PLATFORM retroarch.trimui ra64.trimui_$PLATFORM ra64.miyoo ra64.universal pico8_dyn pico8_64 flycast flycast-stock yabasanshiro yabasanshiro.trimui mupen64plus
}
