#!/bin/sh
# Disabled until misantronic/RAOfflineProxy#169 merges: install-update takes
# the first *spruce*.zip on the release, which can still be the arm64 bundle.
# Not registered in spruce-tasks.json either.
