...
ORIGINAL_PPSSPP_FILE="/mnt/SDCARD/.config/ppsspp/PSP/SYSTEM/ppsspp-$PLATFORM.ini"
ORIGINAL_PPSSPP_CONTROLS_FILE="/mnt/SDCARD/.config/ppsspp/PSP/SYSTEM/controls-$PLATFORM.ini"
