...
mount -o bind "/mnt/SDCARD/spruce/lib" /var/lib ###We mount the folder that includes the alsa configuration, just as the system should include it.
...
mount -o bind "/mnt/SDCARD/spruce/etc/profile" /etc/profile
