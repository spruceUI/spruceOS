...
# Same 32-bit overlay a game launch gets. Without it this app ran on the
# platform cfg's sdl2 joypad driver, which sees no pad on BaseOS, so the
# frontend came up with dead controls.
