...
sleep 0.05
display --okay -i "$BG_IMG" -t "You can browse the games at your leisure, adding them to and removing them from your 'cart' as you go. Once you exit the app, your selections will be downloaded and installed in sequence."
sleep 0.05
display --okay -i "$BG_IMG" -t "Press L1 and R1 to tab through the different groups of games. The A button toggles a game in or out of your 'cart'. When you are ready to 'check out', press the B button."
sleep 0.05
