    ...
    def build_options_list(self):
        ...
        option_list.append(
                GridOrListEntry(
                        ...
                        description=Language.label("downloadBoxartDesc", "Scan entire library for missing boxart"),
                        icon=None,
        ...
        if(Device.get_device().supports_image_resizing()):
            option_list.append(
                GridOrListEntry(
                    ...
                    image_path=None,
                    image_path_selected=None,
                    description=Language.label("optimizeBoxartDesc", "Resize boxart and convert to QOI for faster loading"),
                    icon=None,
        ...
        option_list.append(
            GridOrListEntry(
                ...
                image_path=None,
                image_path_selected=None,
                description=Language.label("lockedDownModesDesc", "Simpler modes for new users or kids"),
                icon=None,
