...
void main()
{
   ...
   if (res.x > 0.85) res.rgb = vec3(0.2,0.8,0.3);
   else if (res.x > 0.6) res.rgb = vec3(0.1,0.6,0.25);
   else if (res.x > 0.3) res.rgb = vec3(0.1,0.35,0.15);
   else res.rgb = vec3(0.0,0.15,0.05);
   FragColor = res;
} 
#endif
